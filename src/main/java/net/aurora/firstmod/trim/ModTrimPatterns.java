...
public class ModTrimPatterns {
    public static final ResourceKey<TrimPattern> BIRTH = ResourceKey.create(Registries.TRIM_PATTERN,
            ResourceLocation.fromNamespaceAndPath(FirstMod.MOD_ID, "birth"));

    public static void bootstrap(BootstrapContext<TrimPattern> context) {
        register(context, ModItems.BIRTH_SMITHING_TEMPLATE, BIRTH);
    }
