...
public class ModItemProvider extends ItemModelProvider {
    ...
    protected void registerModels() {
        ...
        basicItem(ModItems.GALLIUM_HORSE_ARMOR.get());
        basicItem(ModItems.ICE_WAND.get());
        ...
        trimmedArmorItem(ModItems.GALLIUM_BOOTS);
        trimmedArmorItem(ModItems.RAW_BOIIUM_HELMET);
        trimmedArmorItem(ModItems.RAW_BOIIUM_CHESTPLATE);
        trimmedArmorItem(ModItems.RAW_BOIIUM_LEGGINGS);
        trimmedArmorItem(ModItems.RAW_BOIIUM_BOOTS);
